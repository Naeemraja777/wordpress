...
function portfolio_post_type() {
	...
	$labels = array(
		'name'                  => _x( 'portfolio', 'Post Type General Name', 'psd2wp1' ),
		'singular_name'         => _x( 'portfolio', 'Post Type Singular Name', 'psd2wp1' ),
		'menu_name'             => __( 'portfolio', 'psd2wp1' ),
		'name_admin_bar'        => __( 'portfolio', 'psd2wp1' ),
		'archives'              => __( 'portfolio Archives', 'psd2wp1' ),
		'attributes'            => __( 'portfolio Attributes', 'psd2wp1' ),
